...
1. In Vercel → Project → **Settings → Domains** → add `ramwebsites.com` and `www.ramwebsites.com`.
...
- [x] Buy `ramwebsites.com`
- [x] Deploy to Vercel
- [ ] Point DNS at Vercel and verify SSL is active
- [x] `robots.txt` and `sitemap.xml` point at ramwebsites.com
